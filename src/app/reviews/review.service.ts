...
export class ReviewsService {
  ...
  addReview(rating: number, review: string, gameName: string, username: string) {
    const fullReview: Review = {id: null, rating: rating, review: review, gameName: gameName, username: username};
